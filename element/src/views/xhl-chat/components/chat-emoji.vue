<template>
    <div class="m-chat-emoji">
        <div class="emoji-content">
            <div class="cnt">
                <span class="emoji-item" :class="{'pinup-item':item.type==='pinup'}" v-for="(item, index) in currEmoji.list"
                      @click.stop="selectEmoji(item)" :key="index">
                  <img :src="item.img">
                </span>
            </div>
        </div>
        <div class="emoji-channel">
            <span class="emoji-album" :class="{active: item.name==currAlbum}" v-for="(item, index) in emoji"
                  @click.stop="selectAlbum(item)" :key="index">
                <img :src="item.album">
            </span>
            <span v-if="type==='session'" class="emoji-album" :class="{active: item.name==currAlbum}"
                  v-for="(item, index) in pinup" @click.stop="selectAlbum(item)"  :key="index">
                <img :src="item.album">
            </span>
        </div>
    </div>
