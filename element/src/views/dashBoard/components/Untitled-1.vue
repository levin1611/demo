<template>
  ...
  >
    ...
    <el-table-column prop="frame_name" label="框架"> </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            mergeTable() {
                ...
                this.table_data.forEach((item, index) => {
                    if (index === 0) {
                        ...
                        if (
                            item.update_time ===
                            this.table_data[index - 1].update_time
                        ) {
            ...
            tableRowClassName({ row }) {
                return this.active_row_list.some(item => item.update_time === row.update_time)
                    ? 'sucess_row'
                    : '';
            },
            cellMouseEnter(row) {
