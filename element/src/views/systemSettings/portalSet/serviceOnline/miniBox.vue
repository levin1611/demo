    ...
    <div class="container">
        ...
        <div class="preview">
            ...
            <div class="mini-window" :style="'backgroundColor:'+colorSet">
                ...
                <span class="mini-text">{{miniWords}}</span>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            getMiniWordsLength() {
                ...
                for (let i = 0; i < this.miniWords.length; i++) {
                    let c = this.miniWords.charCodeAt(i);
                    // 单字节加1
                ...
                if (len >= 30) {
                    console.log(this.miniWords.length);
            ...
            // 重置数据
            refreshData() {
                if (this.onlineData.miniText) {
                    this.colorSet = this.onlineData.miniColor;
                    this.miniWords = this.onlineData.miniText;
                }
            },
            ...
            checkIsChanged() {
                ...
                // 原始信息
                const oldObj = {
                    colorSet: this.onlineData.miniColor || '#45619D',
                    miniWords: this.onlineData.miniText || 'Chat with us'
                };
