<template>
  <div
    ...
    :class="[
      'filter-component',
      { 'show-filter-component': !isHidden && (filtering || showPopper) },
    ]"
  >
    <Poptip
      :width="width_popper"
    ...
    >
      ...
      <Icon
        ...
        :color="filtering || showPopper ? '#2d8cf0' : undefined"
...
<script>
    ...
    export default {
        ...
        props: [
            ...
            'showAllUsers', // 显示用户包括离职和禁用人员, 用户型筛选用
			'column'
        ],
        computed: {
        ...
        methods: {
            ...
            show() {
                ...
                if (!this.showPopper) {
                    ...
                    this.$emit('update_showPopper', true);
                }
                switch (this.filterType) {
                    case 'string':
            ...
            hide() {
                ...
                if (this.showPopper) {
                    ...
                    this.$emit('update_showPopper', false);
                }
                // 重置访客来源类别的选项
                ...
                reqDepartment.then(data => {
                    ...
                    if (this.withRole) {
                        ...
                        reqUser = this.$commonApi.getCrmUserByleaderOrgId({
                            orgId: this.enterpriseId,
                            status: (this.columnKey === 'companyManagersBefore') || this.showAllUsers ? 1 : undefined
                        });
                    }
                    reqUser.then(data => {
                        console.error(data);
