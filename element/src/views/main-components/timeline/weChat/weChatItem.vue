<template>
    <div class="timeline-item twemoji-convert">
        <div class="item-header clearfloat">
            <!-- 标题 -->
            <div class="item-title">{{ `${JSON.parse(item.eventCustomVar).chatType}` === '1' ? '企微群组' : '企微' }}</div>
