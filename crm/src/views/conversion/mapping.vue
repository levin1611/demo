    ...
    <div class="common-table">
        <div class="common-table-header padding-lr-20">
            <div class="common-table-header-left">
                <p class="common-table-tip">{{$t('clueConversion.mappingTip')}}</p>
            </div>
            <div class="common-table-header-right">
                ...
                <el-button
                    ...
                    @click="createRules"
                >{{$t('clueConversion.addMapping')}}</el-button>
            </div>
        </div>
        <el-table
...
import { queryConversionRuleServiceTypeMapping, updateEnableFlag, delCheckRule } from '@/api/conversion.js';
import newEditMapping from './modal/newEditMapping.vue';
import confirmDialog from '@/components/confirmDialog.vue';
const currentSettingRow = inject('currentSettingRow');  
const columns = ref([
    {
        label: 'clueConversion.mappingfieldName1',
        prop: 'name',
        width: ''
    },
    {
        label: 'clueConversion.mappingfieldName2',
        prop: 'apiKey',
        width: '150'
    },
    {
        label: 'clueConversion.mappingfieldName3',
        prop: '',
        width: ''
    },
    {
        label: 'clueConversion.mappingfieldName4',
        prop: 'notes',
        width: '160'
    },
    {
...
// 获取列表数据
const getListData = () => {
    queryConversionRuleServiceTypeMapping().then(res => {
        if (res.code === 10000) {
